...
INSERT INTO [dbo].[RentalMovies] ([rental_id], [movie_id], [title], [individualstatus])
VALUES
    (1, 1, 'Movie 1', 'Returned'),
    (1, 2, 'Movie 2', 'Returned'),
    (2, 1, 'Movie 1', 'Returned'),
    (3, 3, 'Movie 3', 'Returned');
