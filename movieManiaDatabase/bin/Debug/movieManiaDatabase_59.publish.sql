...
VALUES ('customer1@example.com', 'John', 'Doe', '1990-01-01', '123 Main St'),
       ('customer2@example.com', 'Jane', 'Smith', '1995-05-10', '456 Elm St'),
       ('customer3@example.com', 'Mike', 'Johnson', '1988-09-15', '789 Oak St');

-- Insert sample records into Rentals table
INSERT INTO [dbo].[Rentals] ([customer_id], [movie_id], [rental_date], [return_date], [status])
VALUES (1, 1, '2023-07-01', '2023-07-05', 'Returned'),
       (2, 2, '2023-07-02', NULL, 'Rented'),
       (3, 3, '2023-07-03', NULL, 'Rented');

-- Insert sample records into Movies table
INSERT INTO [dbo].[Movies] ([title], [price], [stock], [rental_id])
VALUES ('Movie 1', 9.99, 5, 1),
       ('Movie 2', 7.99, 10, 2),
       ('Movie 3', 12.99, 3, 3);
