...
IF EXISTS (select top 1 1 from [dbo].[Movies])
...
GO
PRINT N'Dropping Foreign Key unnamed constraint on [dbo].[Rentals]...';


GO
ALTER TABLE [dbo].[Rentals] DROP CONSTRAINT [FK__Rentals__custome__286302EC];
...
GO
ALTER TABLE [dbo].[Rentals] DROP CONSTRAINT [FK__Rentals__movie_i__29572725];
...
GO
ALTER TABLE [dbo].[Rentals] ALTER COLUMN [customer_id] INT NOT NULL;

ALTER TABLE [dbo].[Rentals] ALTER COLUMN [movie_id] INT NOT NULL;
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Movies]...';
...
VALUES
    ...
    ('customer2@example.com', 'Jane', 'Smith', '1985-05-15', '456 Elm St');

-- Insert sample records into the Movies table
INSERT INTO [dbo].[Movies] ([title], [price], [stock], [rental_id])
VALUES
    ('Movie 1', 9.99, 10, 1),
    ('Movie 2', 12.99, 5, 2);

-- Insert sample records into the Rentals table
INSERT INTO [dbo].[Rentals] ([customer_id], [movie_id], [rental_date], [return_date], [status])
VALUES
    (1, 1, '2023-07-01', '2023-08-01', 'Rented'),
    (2, 2, '2023-07-02', '2023-08-02', 'Rented');
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Rentals'), OBJECT_ID(N'dbo.Movies'))
               AND [type] IN (N'F', N'C')
