...
VALUES 
    ('john.doe@example.com', 'John', 'Doe', '1990-01-01', '123 Main St'),
    ('jane.smith@example.com', 'Jane', 'Smith', '1985-05-10', '456 Elm St');

-- Populate Rentals table
INSERT INTO [dbo].[Rentals] ([customer_id], [movie_id], [rental_date], [return_date], [status])
VALUES 
    (1, 1, '2023-07-01', '2023-07-05', 'Returned'),
    (2, 2, '2023-07-02', '2023-07-06', 'Returned');

-- Populate Movies table
INSERT INTO [dbo].[Movies] ([title], [price], [stock], [rental_id])
VALUES 
    ('Movie 1', 9.99, 10, SCOPE_IDENTITY()),
    ('Movie 2', 7.99, 5, SCOPE_IDENTITY());
