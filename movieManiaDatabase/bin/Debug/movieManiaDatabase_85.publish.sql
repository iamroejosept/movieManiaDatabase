...
IF OBJECT_ID('movieManiaDatabase.Movies', 'U') IS NOT NULL
BEGIN
    -- Drop the [Movies] table if it already exists
    DROP TABLE [movieManiaDatabase].[Movies]
END
GO

-- Check if the [Customers] table exists
IF OBJECT_ID('movieManiaDatabase.Customers', 'U') IS NOT NULL
BEGIN
    -- Drop the [Customers] table if it already exists
    DROP TABLE [movieManiaDatabase].[Customers]
END
GO

-- Check if the [Rentals] table exists
IF OBJECT_ID('movieManiaDatabase.Rentals', 'U') IS NOT NULL
BEGIN
    -- Drop the [Rentals] table if it already exists
    DROP TABLE [movieManiaDatabase].[Rentals]
END
GO

-- Check if the [RentalMovies] table exists
IF OBJECT_ID('movieManiaDatabase.RentalMovies', 'U') IS NOT NULL
BEGIN
    -- Drop the [RentalMovies] table if it already exists
    DROP TABLE [movieManiaDatabase].[RentalMovies]
END
GO
